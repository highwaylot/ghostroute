...
export const KEY_INDEX: KeyEntry[] = [
  ...
  { tag: '<img src="" alt="">', desc: 'Shows an image. src is the file, alt is a text backup for screen readers and broken images.' },
  { tag: '<strong>', desc: 'Marks text as important. Browsers show it bold.' },
  { tag: '<em>', desc: 'Marks text with emphasis. Browsers show it italic.' },
  { tag: '<br>', desc: 'A line break. Has no closing tag.' },
  { tag: '<hr>', desc: 'A horizontal divider line. Has no closing tag.' },
  ...
  { tag: '<header>', desc: 'The top introductory section of a page — logo, title, top nav.' },
  { tag: '<nav>', desc: 'Marks a block of navigation links, like a menu bar.' },
  { tag: '<main>', desc: "The primary content of the page. Only one per page." },
